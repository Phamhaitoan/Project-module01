...
function createProduct() {
    if (localStorage.getItem('products') == null) {
        let products = [{
            ...
            img: './dữ liệu/img/products/nam-dui-ga-chay-toi.jpeg',
            category: 'Món mặn',
            price: 200000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/rau-xao-ngu-sac.png',
            category: 'Món mặn',
            price: 180000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/banh_lava_pho_mai_nuong.jpeg',
            category: 'Món mặn',
            price: 180000,
            desc: 'Rau củ quả theo mùa tươi mới xào với nước mắm chay, gia vị để giữ được hương vị ngọt tươi nguyên thủy của rau củ, một món nhiều vitamin và chất khoáng, rất dễ ăn.'
        },
        {
            ...
            img: './dữ liệu/img/products/lau_thai.jpg',
            category: 'Món mặn',
            price: 699000,
        ...
        },
        {
            ...
            status: 1, 
            title: 'Cơm chiên cua',
            img: './dữ liệu/img/products/com_chien_cua.png',
            category: 'Món mặn',
            price: 280000,
...

        {
            ...
            img: './dữ liệu/img/products/sup-bao-ngu-hai-sam.jpeg',
            category: 'Món mặn',
            price: 540000,
...

        {
            ...
            title: 'Tai cuộn lưỡi',
            category: 'Món mặn',
            img: './dữ liệu/img/products/tai-cuon-luoi.jpeg',
            price: 340000,
...

        {
            ...
            img: './dữ liệu/img/products/xiu_mai_tom_thit_10_vien.jpg',
            category: 'Món mặn',
            price: 140000,
...

        {
            ...
            category: "Nước uống",
            img: './dữ liệu/img/products/tra-pho-mai-kem-sua.jpg',
            price: 34000,
        ...
        },
        {
            ...
            category: "Nước uống",
            img: './dữ liệu/img/products/tra-dao-chanh-sa.jpg',
            price: 25000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/banh-chuoi-nuong.jpeg',
            price: 60000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/ha_cao.jpg',
            category: 'Món mặn',
            price: 140000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/thit_nuong.jpg',
            category: 'Món mặn',
            price: 60000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/nom_ga_hoi_an.png',
            category: 'Món mặn',
            price: 60000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/set_bun_ca.jpg',
            category: 'Món mặn',
            price: 60000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/bun_ca_hanh_phi.jpeg',
            category: 'Món mặn',
            price: 60000,
            desc: 'Bún cá được làm đặc biệt hơn với cá trắm lọc xương và chiên giòn, miếng cá nhúng vào nước dùng ăn vẫn giòn dai, thơm ngon vô cùng'
        },
        {
            ...
            img: './dữ liệu/img/products/tom_su_luot_ran_thit.png',
            category: 'Món mặn',
            price: 60000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/banh_cookie_dua.jpeg',
            category: 'Món mặn',
            price: 130000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/sot_mam_thai.jpeg',
            category: 'Món mặn',
            price: 130000,
            desc: 'Bánh cookie dừa ngọt vừa miệng, dừa bào tươi nhào bánh nướng giòn tan, cắn vào thơm lừng, giòn rụm'
        },
        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/tom-su-rang-muoi.jpeg',
            price: 550000,
        ...
        },
        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/tom-su-rang-bo-toi.jpeg',
            price: 550000,
...

        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/combo-vitquay-va-goivit.jpeg',
            price: 510000,
...

        {
            ...
            img: './dữ liệu/img/products/set_ca_tam.jpg',
            category: 'Món mặn',
            price: 950000,
        ...
        },
        {
            ...
            status: 1, 
            title: 'Chả ốc 1 phần',
            img: './dữ liệu/img/products/cha_oc_1_phan.jpeg',
            category: 'Món mặn',
            price: 350000,
...

        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/ga-u-muoi-thao-moc.png',
            price: 450000,
...

        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/ga-khong-loi-thoat.png',
            price: 520000,
...

        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/ca-chien-gion-mam-thai.jpeg',
            price: 350000,
...

        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/chan-gio-chien-gion-mam-thai.jpeg',
            price: 420000,
...

        {
            ...
            title: 'Chả cốm (500gr)',
            category: 'Món mặn',
            img: './dữ liệu/img/products/cha-com.png',
            price: 175000,
...

        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/vit-om-sau.jpeg',
            price: 350000,
...

        {
            ...
            title: 'Giò xào (1kg)',
            category: 'Món mặn',
            img: './dữ liệu/img/products/gio-xao.jpeg',
            price: 460000,
...

        {
            ...
            title: 'Nem tai (1 hộp)',
            category: 'Món mặn',
            img: './dữ liệu/img/products/nem-tai.jpeg',
            price: 200000,
...

        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/canh-dua-bo-ham.jpeg',
            price: 270000,
...

        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/nac-nong-heo-nuong-kem-xoi-trang.jpeg',
            price: 300000,
...

        {
            ...
            category: 'Món mặn',
            img: './dữ liệu/img/products/thit-quay.jpeg',
            price: 280000,
...

        {
            ...
            title: 'Khâu nhục',
            category: 'Món mặn',
            img: './dữ liệu/img/products/khau-nhuc.jpeg',
            price: 280000,
        ...
        },
        {
            ...
            title: 'Xíu mại tôm thịt ( 10 viên)',
            category: 'Món mặn',
            img: './dữ liệu/img/products/ha_cao_tom_thit.jpg',
            price: 140000,
            desc: 'Những miếng há cảo, sủi cảo, hoành thánh với phần nhân tôm, sò điệp, hải sản tươi ngon hay nhân thịt heo thơm ngậy chắc chắn sẽ khiến bất kỳ ai thưởng thức đều cảm thấy rất ngon miệng.'
        },
        {
            ...
            category: 'Món tráng miệng',
            img: './dữ liệu/img/products/che-com-la-dua.jpeg',
            price: 60000,
...

        {
            ...
            category: 'Món tráng miệng',
            img: './dữ liệu/img/products/banh-bong-lan-chanh-day.jpeg',
            price: 50000,
...

        {
            ...
            title: 'Chè bưởi',
            category: 'Món tráng miệng',
            img: './dữ liệu/img/products/che-buoi.jpeg',
            price: 50000,
        ...
        },
        {
            ...
            category: "Món lẩu",
            img: './dữ liệu/img/products/lau-thai-tomyum.jpeg',
            price: 699000,
            desc: 'Lẩu Thái là món ăn xuất phát từ món canh chua Tom yum nổi tiếng của Thái Lan. Nước lẩu có hương vị chua chua cay cay đặc trưng. Các món nhúng lẩu gồn thịt bò, hải sản, rau xanh và các loại nấm.',
        },
        {
            ...
            category: "Món lẩu",
            img: './dữ liệu/img/products/lau-thai-nam-chay.png',
            price: 550000,
        ...
        },
        {
            ...
            category: "Món chay",
            img: './dữ liệu/img/products/dau-hu-xao-nam-chay.png',
            price: 220000,
        ...
        },
        {
            ...
            category: "Món chay",
            img: './dữ liệu/img/products/bun-tron-chay.png',
            price: 75000,
        ...
        },
        {
            ...
            category: "Món chay",
            img: './dữ liệu/img/products/bun-rieu-chay.png',
            price: 75000,
        ...
        },
        {
            ...
            category: "Món chay",
            img: './dữ liệu/img/products/mien-xao-rau-cu-chay.png',
            price: 170000,
        ...
        },
        {
            ...
            category: "Món chay",
            img: './dữ liệu/img/products/cuon-nam-chay.png',
            price: 120000,
        ...
        },
        {
            ...
            title: 'Xôi xéo',
            category: "Món chay",
            img: './dữ liệu/img/products/xoi-xeo.png',
            price: 80000,
        ...
        },
        {
            ...
            title: 'Chả quế chay',
            category: "Món chay",
            img: './dữ liệu/img/products/cha-que-chay.png',
            price: 70000,
            desc: '',
        },
        {
            ...
            title: 'Nem chay',
            category: "Món chay",
            img: './dữ liệu/img/products/nem-chay.png',
            price: 160000,
        ...
        },
        {
            ...
            category: "Món ăn vặt",
            img: './dữ liệu/img/products/banh-trang-tron.jpg',
            price: 20000,
        ...
        },
        {
            ...
            category: "Món ăn vặt",
            img: './dữ liệu/img/products/banh-trang-nuong.jpg',
            price: 10000,
        ...
        },
        {
            ...
            category: "Món ăn vặt",
            img: './dữ liệu/img/products/oc-thap-cam.jpg',
            price: 50000,
        ...
        },
        {
            ...
            category: "Món ăn vặt",
            img: './dữ liệu/img/products/com-chay-cha-bong.jpg',
            price: 60000,
        ...
        },
        {
            ...
            category: "Món ăn vặt",
            img: './dữ liệu/img/products/pha-lau.jpg',
            price: 99000,
        ...
        },
        {
            ...
            category: "Món ăn vặt",
            img: './dữ liệu/img/products/bot-chien.jpg',
            price: 49000,
        ...
        },
        {
            ...
            category: "Món ăn vặt",
            img: './dữ liệu/img/products/goi-bo-kho.jpg',
            price: 60000,
        ...
        },
        {
            ...
            img: './dữ liệu/img/products/hoanh_thanh.jpg',
            category: 'Món mặn',
            price: 130000,
            desc: 'Những miếng há cảo, sủi cảo, hoành thánh với phần nhân tôm, sò điệp, hải sản tươi ngon hay nhân thịt heo thơm ngậy chắc chắn sẽ khiến bất kỳ ai thưởng thức đều cảm thấy rất ngon miệng.'
        },
        {
            ...
            img: './dữ liệu/img/products/nuoc-ep-dau-tay.jpg',
            category: 'Nước uống',
            price: 100000,
