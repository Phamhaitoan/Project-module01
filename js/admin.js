function checkLogin() {
    ...
    if(currentUser == null || currentUser.userType == 0) {
        document.querySelector("body").innerHTML = `<div class="access-denied-section">
            <img class="access-denied-img" src="./dữ liệu/img/access-denied.webp" alt="">
        </div>`
    } else {
...
function getPathImage(path) {
    ...
    return "./dữ liệu/img/products/" + patharr[patharr.length - 1];
}
...
function setDefaultValue() {
    document.querySelector(".upload-image-preview").src = "./dữ liệu/img/blank-image.png";
...
function uploadImage(el) {
    let path = "./dữ liệu/img/products/" + el.value.split("\\")[2];
